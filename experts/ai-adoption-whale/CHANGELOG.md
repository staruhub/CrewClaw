...
- Added the runtime deep spec (`crewclaw.employee.yaml`): role contract, tool needs, permission policy, playbooks, eval_suite + outcome_rubric, memory seed, dream policy, compatibility targets.
- Aligned the version across registry / hire.yaml / distribution.yaml / crewclaw.employee.yaml (they had drifted).
