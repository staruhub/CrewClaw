...

{
  const md = renderReport({
    taskRun: { id: 't1', user_goal: '调研 Seed 2.1', employee_id: 'whale', status: 'delivered', effective: false, tool_invocations: [] },
    deliverable: '正文内容',
    sources: ['https://a.com'],
...
{
  const md = renderReport({
    taskRun: { id: 't2', user_goal: 'x', employee_id: 'w', status: 'failed', tool_invocations: [] }
  });
