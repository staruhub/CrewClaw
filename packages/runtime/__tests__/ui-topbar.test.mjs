...
{
  const bar = topBar({ title: "Hi", tokens: 39413, ctxPct: 20, cost: 0.29 }, { color: false, width: 40 });
...
{
  const cap = [];
  const fake = { isTTY: true, columns: 80, rows: 24, write: (s) => cap.push(s), on() {}, off() {} };
  const installed = installTopBar(() => ({ title: "Hi", tokens: 39413, ctxPct: 20, cost: 0.29 }), { stream: fake });
