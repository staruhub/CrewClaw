...
const releaseBinary = resolve(root, "crates/crewclaw-cli/target/release/crewclaw-cli");
const debugBinary = resolve(root, "crates/crewclaw-cli/target/debug/crewclaw-cli");
...
const args = binary
  ...
  : ["run", "--quiet", "--manifest-path", manifest, "--", ...process.argv.slice(2)];
