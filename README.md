...
<p align="center">
  ...
  <a href="docs/releases/beta-0.8.md"><img alt="Beta 0.8" src="https://img.shields.io/badge/release-Beta%200.8-1F8A70" /></a>
...
- **AI 员工市场**：浏览角色、开源许可、证据级别、运行时兼容性和能力边界。
...
CrewClaw 当前通过 **Beta 0.8 prerelease** 发布：
...
接口、本地状态结构和打包方式仍可能在 Beta 阶段变化。升级、回滚、验证命令和已知限制见 [Beta 0.8 发布说明](docs/releases/beta-0.8.md)。
...
- CrewClaw 与 OpenWork 均按 Apache-2.0 完整开源；网站不提供产品收费、订阅或购买流程。模型与第三方服务商用量由用户自己的账户承担。
...
- **Beta 0.8**：官网与市场统一为 Apache-2.0 开源分发，移除收费、候补名单和伪发布数据，并明确 OpenWork 当前真实能力边界。
