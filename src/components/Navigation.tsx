...
export function Navigation({ onGetStarted }: NavigationProps) {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-[1000] h-20 transition-[background-color,border-color,backdrop-filter] duration-500 ${
          scrolled
      ...
      >
        <div className="site-container flex h-full items-center justify-between">
          ...
          <div className="hidden md:block">
            <button
              ...
              className="border border-white/10 bg-white/[0.04] text-crew-heading font-sans text-[13px] px-5 py-2.5 rounded-sm hover:border-crew-copper/40 hover:bg-white/[0.06] transition-[background-color,border-color]"
            >
              Hire an expert
            </button>
          </div>
        ...
        {mobileOpen && (
          <div
            ...
            className="md:hidden bg-[#0B0908]/95 backdrop-blur-xl border-b border-crew-border/70 px-6 pb-6 pt-2"
          >
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="border border-white/10 bg-white/[0.04] text-crew-heading font-sans text-sm px-6 py-2.5 rounded-sm hover:border-crew-copper/40 hover:bg-white/[0.06] transition-[background-color,border-color] w-full mt-2"
              >
                Hire an expert
              </button>
            </div>
